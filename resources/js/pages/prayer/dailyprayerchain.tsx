...
export default function Welcome() {
    ...
    const { dailyPrayerChain } = usePage().props;
            ...
            <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                    ...
                    <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Welcome {auth.user.name}, to the {dailyPrayerChain[0].session}.<br />
                        We suggest starting with the following.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {dailyPrayerChain.map((prayer, index) => (
                            <div key={index} className="p-4 border rounded shadow">
                                <h2 className="font-bold text-lg">{prayer.category}</h2>
                                <p className="italic">{prayer.title}</p>
                                {prayer.scripture && <blockquote>📖 {prayer.scripture}</blockquote>}
                                <p className="mt-2">{prayer.decree || prayer.prayer}</p>
                            </div>
                        ))}
                    </div>
                </div>
